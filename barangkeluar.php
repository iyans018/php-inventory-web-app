...
if (isset($_POST["tambah"])) {
    ...
    $tambahKeluar = mysqli_query($conn, "INSERT INTO tb_keluar (id_barang, qty, penerima) VALUES ('$id_barang','$qty','$penerima')");
    $updateStock = mysqli_query($conn, "UPDATE tb_barang SET stock=$stock_baru WHERE id_barang='$id_barang'");
    if ($tambahKeluar && $updateStock) {
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><a href="index.php">Dashboard</a> / Barang Keluar</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="barangkeluar.php" method="post">
                                    <div class="mb-3">
